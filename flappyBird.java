...
public class flappyBird implements Jogo {
	...
	public flappyBird() {
		passaro = new Passaro(35, (getLargura() - 112) / 2 + 24 / 2, ground_offset);
		// canos.add(new Cano(getLargura()+50, gerador.nextInt(getAltura() - 112 -
		// Cano.HOLESIZE), -gvx));
	...
	public void desenhar(Tela t) {
		...
		t.imagem("flappy.png", 0, 0, 288, 512, 0, 288 * 2, 0);
